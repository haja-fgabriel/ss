    ...
    )
{
    ...
    if (*State == CONN_UNAUTHENTICATED)
    {
        ...
        else if (0 == _stricmp(Command, CMD_RAND))
        {
            ...
            // TODO add output array length as parameter in InterpretCommand function
            if (!CmdHandleRand(Parameter, Output, DEFAULT_BUFLEN, OutLength))
            {
        ...
        else if (0 == _stricmp(Command, CMD_RAND_QUOTE))
        {
            ...
            // TODO add output array length as parameter in InterpretCommand function
            if (!CmdHandleRandQ(Parameter, Output, DEFAULT_BUFLEN, OutLength))
            {
